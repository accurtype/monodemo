...
hoistedDependencies:
  ...
  '@commitlint/load@19.5.0(@types/node@20.17.6)(typescript@5.6.3)':
  ...
  '@eslint/js@9.14.0':
    '@eslint/js': public
  '@eslint/markdown@6.1.0(eslint@9.14.0(jiti@1.21.6))':
  ...
  cross-spawn@7.0.5:
    cross-spawn: private
  cz-conventional-changelog@3.3.0(@types/node@20.17.6)(typescript@5.6.3):
  ...
  eslint-config-accurtype-style@0.2.3(eslint@9.14.0(jiti@1.21.6))(typescript@5.6.3):
...
pendingBuilds: []
prunedAt: Sat, 09 Nov 2024 13:32:13 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
